    ...
    <div id="education" className="md:w-2/5 mx-auto mt-20 mb-10
        ...
        <div className="">
            <h1 className="md:p-5 md:w-1/4 m-auto bg-yellow-300 rounded-xl text-center text1 text-2xl
                           p-2 w-5/6"> Education </h1>
            <div className="md:mt-10 mt-3 w-5/6 flex flex-col mx-auto">
                <details open={true} className='mt-10 cursor-pointer'>
                    <summary className='text1 md:text-3xl text-xl text-gray-600'>HighSchool: Colegio Internacional (1996-2001)</summary>
                    <p className='text1 md:text-2xl text-sm text-gray-600'>During this period I was learning and exploring coding with Turbo Pascal</p>
                </details>
                <details open={true} className='mt-10 cursor-pointer'>
                    <summary className='text1 md:text-3xl text-xl text-gray-600'>College: Petroleum Engineer (2002-2009)</summary>
                    <p className='text1 md:text-2xl text-gray-600'>During this period I used Visual Basic, Borland C. My bachelor's thesis was about an app to storage oil fields data in a friendly user interface. I used php, html and MySQL</p>
                </details>
                <details open={true} className='mt-10 cursor-pointer'>
